...
Top.pack(side=TOP)
M = Frame(root, width=650, bg="black")
M.pack(side=BOTTOM)
F = Frame(width=7, height=8, bd=10, bg="black")
F.pack(side=BOTTOM)
...
# LABELS
label_title = Label(Top, text="Contact System", bd=7, relief=GROOVE, fg="Black", bg="white",
...
bg="white", command=MyNewContact).grid(row=0, column=0, ipadx=20, padx=30)

Delete_Button = Button(F, text='Delete The Contact', font=('Calibri', 17, 'bold'), command=Delete,
fg="black", bg="white").grid(row=0, column=1, ipadx=20)

Exit_Button = Button(F, text='Exit System', font=('Calibri', 17, 'bold'), command=Exit,
fg="black", bg="white").grid(row=0, column=2, ipadx=20, padx=30)
